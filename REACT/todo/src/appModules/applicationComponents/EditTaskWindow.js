...
export default function EditTaskWindow(props){
    ...
    return(
        ...
        <div>
            ...
            <input type="text" name={`${props.id}_newTaskTitle`} id={`${props.id}_newTaskTitle`} onChange={(e)=>updateInputData(e,props.changeInputState)} value={props.inputState[`${props.id}_newTaskTitle`]}></input>
        </div>
        <div>
            <label htmlFor="newTaskDescription" >Wprowadź nowy opis</label>
            <input type="text" name={`${props.id}_newTaskDescription`} id={`${props.id}_newTaskDescription`} value={props.inputState[`${props.id}_newTaskDescription`]} onChange={(e)=>updateInputData(e,props.changeInputState)}></input>
        </div>
        <div>
            <label htmlFor={`${props.id}_newTaskPriority`}>Wprowadź nową ważność:</label>
            <select name={`${props.id}_newTaskPriority`} id={`${props.id}_newTaskPriority`} onChange={(e)=>updateInputData(e,props.changeInputState)} defaultValue="2">
        ...
        <div>
            ...
            <input type="date" name={`${props.id}_newDeadlineDate`} id={`${props.id}_newDeadlineDate`} value={props.inputState[`${props.id}_newDeadlineDate`]} onChange={(e)=>updateInputData(e,props.changeInputState)}></input>
            <p className="error"></p>
        </div>
